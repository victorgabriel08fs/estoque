        ...
        <div class="card mb-5">
            ...
            <form action="{{ route('categories.index') }}">
                ...
                <div class="card-footer d-flex justify-content-between">
                    <div>
                        <a href="{{ route('categories.index') }}" class="btn btn-outline-secondary">Clear fields</a>
                        <button type="submit" class="btn btn-outline-primary">Search</button>
                    </div>
            </form>
            <div>
                @can('Create Categories')
                    @include('categories._partials.new_modal')
                @endcan
            </div>
        </div>
    </div>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a class="btn btn-icon btn-primary"
                                            href="{{ route('categories.show', $item) }}"><svg
                                        ...
                                        @can('Edit Categories')
                                            @include('categories._partials.edit_modal', [
                                                'category' => $item,
                                            ])
                                        @endcan
